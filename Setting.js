...
global.github    = 'https://github.com/samridhya01' ;
...
global.owner = process.env.OWNER_NUMBER  || '919062628928' ;  // ADD YOUR NUMBER WITHOUT +
...
global.sudo  =  process.env.SUDO || "919062628928" ;          // DON'T REMOVE
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '26_04_2024_SIGMA_MD_iK9P7Mda_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'Samrat CS',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `Samriddho`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'XD',      // ADD YOUR STICKER AUTHOR NAME
  ...
  OPENAI_API_KEY: process.env.OPENAI_API_KEY ||'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' ,    // ADD YOUR OPEN AI KEY IF YOU HAVE
  REMOVE_BG_KEY: process.env.REMOVE_BG_KEY   || "fNRaWnb5PF6PoPKZ4fTjkLBQ",    // ADD YOUR REMOVE BG KEY IF YOU HAVE
  //=================================================================================
